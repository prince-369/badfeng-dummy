...
export default function PromoBanner() {
  return (
    <section className="mx-auto w-full max-w-[1240px] px-2 py-2 sm:px-3">
      <div data-gsap-hover className="overflow-hidden rounded-[34px] border border-[#7da6c7] shadow-xl shadow-slate-900/20 sm:rounded-[24px] sm:border-0">
        <div
          data-gsap="promo-image"
          className="gsap-hover-image relative h-[184px] bg-cover bg-center sm:min-h-[300px] sm:px-10 sm:py-14"
          style={{
        ...
        >
          ...
          <div className="relative z-20 hidden sm:mx-auto sm:block sm:max-w-[700px] sm:space-y-3 sm:text-center sm:text-white sm:ml-auto sm:mr-[90px]">
            ...
            <button className="gsap-cta inline-flex items-center gap-3 rounded-full bg-[#056db6] px-6 py-2.5 text-[16px] font-medium text-white transition hover:bg-[#04558f]">
