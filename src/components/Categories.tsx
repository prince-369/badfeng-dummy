    ...
    <section className="relative z-10 mx-auto grid w-full max-w-[1240px] gap-3 px-2 py-2 sm:px-3 lg:mt-[-18px] lg:grid-cols-[2fr_1fr_250px]">
      ...
      <article data-gsap-hover className="w-full overflow-hidden rounded-[32px] border border-[#a9bfd0] bg-[#d7e2eb] px-4 py-4 sm:h-auto sm:rounded-[24px] sm:border-0 sm:bg-[#e8f0f6]">
          ...
          <div className="w-full overflow-x-auto overflow-y-hidden pb-1 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
            <div className="flex gap-3" style={{ width: 'max-content' }}>
              {moreCategoryImages.map((imagePath, index) => (
                <div key={imagePath} data-gsap-hover className="h-[162px] w-[150px] shrink-0 overflow-hidden rounded-[22px] bg-[#c9deed]">
                  <Image
                    src={imagePath}
        ...
        <div className="mt-3 hidden grid-cols-5 gap-2 sm:grid">
          {moreCategoryImages.map((imagePath) => (
            <div key={imagePath} data-gsap-hover className="overflow-hidden rounded-[18px] bg-[#c9deed]">
              <Image
                src={imagePath}
                alt="Category item"
                width={218}
                height={238}
                className="gsap-hover-image h-[86px] w-full object-cover sm:h-[74px]"
              />
            </div>
          ))}
        </div>
      ...
      <div className="sm:hidden">
        <div className="w-full overflow-x-auto overflow-y-hidden overscroll-x-contain touch-pan-x pb-1 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
          <div className="flex gap-3" style={{ width: 'max-content' }}>
            <article data-gsap-hover className="relative h-[560px] w-[296px] shrink-0 overflow-hidden rounded-[26px] bg-[#e8f0f6] px-5 py-4">
              ...
              <Image
                ...
                width={272}
                height={430}
                className="gsap-hover-image pointer-events-none absolute left-[57%] top-[30px] h-[560px] w-[336px] -translate-x-1/2 rotate-[6deg] object-contain"
              />
            ...
            <article data-gsap-hover className="relative h-[560px] w-[296px] shrink-0 overflow-hidden rounded-[26px] bg-[#e8f0f6] px-5 py-4">
              ...
              <Image
                ...
                width={193}
                height={193}
                className="gsap-hover-image pointer-events-none absolute left-1/2 top-[58px] h-[515px] w-[316px] -translate-x-1/2 rotate-[10deg] object-contain"
              />
