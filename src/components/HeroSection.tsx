...
export default function HeroSection() {
  return (
    <section className="relative mx-auto grid w-full max-w-[1240px] gap-3 px-2 pb-2 pt-2 lg:grid-cols-[1fr_250px] sm:px-3">
      <div className="relative min-h-[744px] overflow-hidden rounded-[32px] border border-[#9ab4c8] bg-[#d7e2eb] px-6 pb-6 pt-6 sm:min-h-[430px] sm:rounded-[24px] sm:border-0 sm:bg-[#e5edf4] sm:px-11 sm:pt-9 lg:min-h-[360px]">
        ...
        <div className="relative z-10 max-w-[340px] space-y-4 pt-[430px] sm:max-w-[320px] sm:space-y-4 sm:pt-0">
          ...
          <button className="inline-flex items-center gap-3 rounded-full bg-[#056db6] px-6 py-2 text-[15px] font-medium text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.2)] sm:px-5 sm:py-1.5 sm:text-[16px]">
            View All Product
        ...
        <Image
          ...
          width={292}
          height={462}
          className="pointer-events-none absolute left-1/2 top-[22px] z-10 h-[392px] w-auto -translate-x-1/2 object-contain sm:bottom-[36px] sm:left-[68%] sm:top-auto sm:h-[400px] lg:left-[71.5%] lg:h-[500px]"
          priority
        />
      ...
      <div className="relative hidden lg:block">
        <article className="relative min-h-[206px] overflow-hidden rounded-[24px] bg-[#f5f7fa] px-4 py-3">
        ...
        <article className="mt-3 rounded-[24px] bg-[#f5f7fa] px-3 py-3 pb-7 shadow-[0_10px_24px_rgba(0,0,0,0.06)] lg:absolute lg:left-0 lg:right-0 lg:top-[218px] lg:mt-0 lg:z-30">
