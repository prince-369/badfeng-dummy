...
export default function SaleTimer() {
  return (
    <article data-gsap-hover className="relative min-h-[580px] overflow-hidden rounded-[34px] border border-[#a9bfd0] bg-[#e5eef5] px-6 py-6 sm:min-h-[370px] sm:rounded-[24px] sm:border-0 sm:bg-[#e8f0f6] sm:p-4 lg:min-h-[540px]">
      ...
      <Image
        ...
        width={468}
        height={514}
        className="gsap-hover-image mx-auto mt-4 h-[265px] w-[300px] object-contain sm:mt-2 sm:h-[230px] sm:w-[250px]"
      />
